...
\title{\fontsize{25}{30}\selectfont 地科探究：聖嬰現象與反聖嬰現象對台灣西半部海域水溫的影響}
...
地球科學、聖嬰現象、反聖嬰現象、台灣西半部海域、水溫變化、
 \href{https://weilinlai719.github.io/earth-science-explore/}{聖嬰現象與反聖嬰現象觀察}
\section{簡介}
\section{引言}
\section{研究背景}
\qquad
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{2021-7.png} % 假設你有一個 earth.jpg
    \caption{2021-7月台灣西半部海域水溫變化圖}
    \label{fig:earth}
\end{figure}
\section{結論}
\qquad
